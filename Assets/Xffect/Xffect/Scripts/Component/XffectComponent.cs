...
namespace Xft
{
    ...
    {
        #region Member
        static public string CurVersion = "5.3.2";
        public string MyVersion = "5.3.2";
        ...
        MeshFilter CreateMeshObj(Material mat)
        {
            ...
            if (!EditorApplication.isPlaying)
            {
                ...
                EditorUtility.SetSelectedRenderState(obj.GetComponent<Renderer>(), EditorSelectedRenderState.Hidden);
            }
#endif
