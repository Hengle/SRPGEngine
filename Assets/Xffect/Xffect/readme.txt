...
--------------------
Version 5.3.2
-FIX: This tool is now compatible with Unity5.5
-FIX: Minor bugs fixed.

Version 5.3.1
-Improved: No Gc Alloced in LateUpdate() function now, Thanks to "Ali Abdul-Karim"'s solution.

Version 5.3.0
-FIX: *"Max nodes" option can be changed dynamically without console errors.
-FIX: "Camera Effects" curve's range fixed.
